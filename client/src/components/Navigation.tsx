    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? "bg-[oklch(0.12_0.01_260/0.95)] backdrop-blur-md border-b border-white/5"
            : "bg-transparent"
        }`}
      >
          ...
          <div className="hidden md:flex items-center gap-8">
            {navItems.map((item) => (
              <a
                ...
                className="text-sm font-medium tracking-wide text-white/70 hover:text-teal transition-colors relative group"
              >
                {item.label}
            ...
            <div className="relative">
              <button
                ...
                className="text-sm font-medium tracking-wide text-white/70 hover:text-teal transition-colors flex items-center gap-1"
              >
                More
              ...
              <AnimatePresence>
                {moreOpen && (
                  <motion.div
                    ...
                    className="absolute top-full right-0 mt-3 w-56 bg-[oklch(0.17_0.012_260)] border border-white/8 shadow-2xl"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[oklch(0.12_0.01_260/0.98)] backdrop-blur-xl pt-20"
          >
